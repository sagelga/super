                ...
                {featured && (
                    <div className="space-y-4">
                        ...
                        >
                            ...
                            <div>
                                <h2 className="mb-1 font-serif text-3xl font-semibold text-text transition-colors group-hover:text-accent">
                                    {featured.title}
                                </h2>
                        ...
                        <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
                            {rest.map((topic) => (
                                ...
                                >
                                    ...
                                    <div>
                                        <h2 className="mb-1 font-serif text-lg font-semibold text-text transition-colors group-hover:text-accent">
                                            {topic.title}
                                        </h2>
