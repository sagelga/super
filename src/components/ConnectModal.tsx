            ...
            <div className="flex flex-col gap-1 p-1">
                {socials.map((s) => (
                    <a
                        ...
                        onClick={onClose}
                        className="flex items-center gap-4 rounded px-4 py-3 text-muted transition-colors hover:bg-surface hover:text-cream"
                    >
                        <span className="shrink-0 text-muted">{s.icon}</span>
