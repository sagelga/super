    ...
    >
        ...
        <g mask="url(#bm)" filter="url(#bf)">
            ...
            <path
                ...
                stroke="url(#stalk-col)"
                strokeWidth="10"
                strokeLinecap="round"
            />
            <path
                d="M41 365 Q50 361 60 365"
                stroke="url(#stalk-col)"
                strokeWidth="3"
                strokeLinecap="round"
            />
            <path
                d="M40 230 Q49 226 59 230"
                stroke="url(#stalk-col)"
                strokeWidth="3"
                strokeLinecap="round"
            />
            <path
                d="M40  95 Q49  91 59  95"
                stroke="url(#stalk-col)"
                strokeWidth="3"
                strokeLinecap="round"
            />
            ...
            <path
                d="M49 90 C26 68 8 40 12 14 C18 40 29 65 49 90Z"
                fill="url(#lf1)"
                className="bamboo-leaf"
                style={{
                    transformOrigin: "49px 90px",
                    ["--sway-delay" as string]: "0s",
                }}
            />
            <path
                d="M49 90 C73 72 90 48 89 22 C80 48 68 68 49 90Z"
                fill="url(#lf2)"
                className="bamboo-leaf"
                style={{
                    transformOrigin: "49px 90px",
                    ["--sway-delay" as string]: "0.6s",
                }}
            />
            <path
                d="M50 225 C25 205 6 180 9 155 C17 180 29 202 50 225Z"
                fill="url(#lf3)"
                className="bamboo-leaf"
                style={{
                    transformOrigin: "50px 225px",
                    ["--sway-delay" as string]: "1.1s",
                }}
            />
            <path
                d="M50 225 C77 210 94 188 96 163 C84 188 71 207 50 225Z"
                fill="url(#lf4)"
                className="bamboo-leaf"
                style={{
                    transformOrigin: "50px 225px",
                    ["--sway-delay" as string]: "1.7s",
                }}
            />
            ...
            />
            <path
                d="M135 358 Q145 354 155 358"
                stroke="url(#stalk-col)"
                strokeWidth="2.5"
                strokeLinecap="round"
            />
            <path
                d="M136 220 Q146 216 156 220"
                stroke="url(#stalk-col)"
                strokeWidth="2.5"
                strokeLinecap="round"
            />
            ...
            <path
                d="M149 108 C124 88 108 62 112 38 C120 62 131 85 149 108Z"
                fill="url(#lf5)"
                className="bamboo-leaf"
                style={{
                    transformOrigin: "149px 108px",
                    ["--sway-delay" as string]: "0.3s",
                }}
            />
            <path
                d="M149 108 C176 94 192 72 190 48 C180 72 166 91 149 108Z"
                fill="url(#lf6)"
                className="bamboo-leaf"
                style={{
                    transformOrigin: "149px 108px",
                    ["--sway-delay" as string]: "0.9s",
                }}
            />
            <path
                d="M147 214 C122 196 106 172 109 148 C118 172 130 193 147 214Z"
                fill="url(#lf7)"
                className="bamboo-leaf"
                style={{
                    transformOrigin: "147px 214px",
                    ["--sway-delay" as string]: "1.4s",
                }}
            />
            <path
                d="M147 214 C174 200 190 178 190 154 C178 178 164 197 147 214Z"
                fill="url(#lf8)"
                className="bamboo-leaf"
                style={{
                    transformOrigin: "147px 214px",
                    ["--sway-delay" as string]: "2s",
                }}
            />
        </g>
    </svg>
