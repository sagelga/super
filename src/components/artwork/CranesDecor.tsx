...
const CranesDecor: React.FC<Props> = ({ className }) => (
    ...
    >
        ...
        <g mask="url(#cm)" filter="url(#cf)">
            {/* Crane 1 — slower drift */}
            <g className="crane-drift">
                <path
                    d="M245 98 C228 90 213 87 208 94 C203 101 210 114 228 119 C246 124 264 116 263 106 C262 96 255 103 245 98Z"
                    fill="url(#c1-body)"
                />
                <path
                    d="M220 93 C196 78 168 62 135 48 C170 65 198 81 220 93Z"
                    fill="url(#c1-wl)"
                />
                <path
                    d="M220 100 C200 109 174 120 145 134 C175 118 202 107 220 100Z"
                    fill="url(#c1-wlb)"
                />
                <path
                    d="M250 93 C274 78 298 62 328 48 C296 64 271 79 250 93Z"
                    fill="url(#c1-wr)"
                />
                <path
                    d="M250 100 C270 108 294 118 322 130 C292 118 268 107 250 100Z"
                    fill="url(#c1-wrb)"
                />
                <path
                    d="M258 88 C270 76 282 60 292 46"
                    stroke="url(#c1-wl)"
                    strokeWidth="7"
                    strokeLinecap="round"
                />
            ...
            {/* Crane 2 — counter drift for parallax */}
            <g className="crane-drift-alt">
                <path
                    d="M115 42 C104 37 96 35 93 40 C90 45 96 53 108 57 C120 61 131 54 130 47 C129 40 120 45 115 42Z"
                    fill="#1A1A1A"
                    opacity="0.85"
                />
                <path
                    d="M100 39 C86 31 70 23 54 16 C72 25 88 33 100 39Z"
                    fill="url(#c2-wl)"
                />
                <path
                    d="M100 44 C88 50 74 57 58 65 C74 55 89 48 100 44Z"
                    fill="url(#c2-wl)"
                    opacity="0.7"
                />
                <path
                    d="M118 39 C132 31 146 23 163 15 C145 25 131 33 118 39Z"
                    fill="url(#c2-wr)"
                />
                <path
                    d="M118 44 C130 50 144 57 160 65 C144 55 129 48 118 44Z"
                    fill="url(#c2-wr)"
                    opacity="0.65"
                />
                <path
                    d="M125 36 C132 28 140 19 148 12"
                    stroke="#1A1A1A"
                    strokeWidth="4.5"
                    strokeLinecap="round"
                    opacity="0.8"
