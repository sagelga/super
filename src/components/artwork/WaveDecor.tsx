    ...
    >
        ...
        <g mask="url(#wm)" filter="url(#wf)">
            ...
            <path
                ...
                stroke="url(#wave-back)"
                strokeWidth="2"
                strokeLinecap="round"
                opacity="0.7"
                className="decor-wave-path"
                style={{
            ...
            />
            <path
                d="M112 30 C106 20 104 10 111 7 C118 4 128 12 128 22"
                stroke="url(#wave-main)"
                strokeWidth="1.5"
                strokeLinecap="round"
            />
            ...
            />
            <path
                d="M358 24 C352 14 350 4 357 1 C364 -2 374 7 373 16"
                stroke="url(#wave-main)"
                strokeWidth="1.5"
                strokeLinecap="round"
            />
