...
export const Button: React.FC<ButtonProps> = ({
    ...
    const variantClasses = {
        primary: "bg-brand text-cream hover:bg-brand-600 focus:ring-brand",
        secondary: "bg-rim text-cream hover:bg-surface focus:ring-accent",
        outline:
            "border-2 border-brand-400 text-brand-400 hover:bg-brand-900 focus:ring-brand",
        ghost: "text-brand-400 hover:bg-brand-900 focus:ring-brand",
        danger: "bg-accent-700 text-cream hover:bg-accent-600 focus:ring-accent",
    };
...
export const IconButton: React.FC<IconButtonProps> = ({
    ...
    const variantClasses = {
        primary: "bg-brand text-cream hover:bg-brand-600 focus:ring-brand",
        secondary: "bg-rim text-cream hover:bg-surface focus:ring-accent",
        ghost: "text-muted hover:bg-surface focus:ring-accent",
    };
