export const skills = [
  "JavaScript", "TypeScript", "Salesforce Apex", "Salesforce SOQL", "Python", "MySQL", "PostgreSQL", "Oracle SQL", "Microsoft T-SQL",
  "Oracle PL/SQL", "HTML", "CSS", "Vue", "React",
  "MongoDB", "Salesforce CRM (SFDC)", "Salesforce Marketing Cloud (SFMC)",
  "Amazon Web Services (AWS)", "Microsoft Office", "Cloudflare",
  "Git",
  "Google Analytics", "Figma", "Jira", "GitHub", "Postman", "Bing Webmaster Tools",
  "Google Search Console", "Meta Business Suite", "WordPress", "Visual Studio Code",
  "Jupyter Notebook", "DataGrip", "Cloudinary", "Notion", "Netlify", "Docker",
  "Algolia", "Hotjar", "Canva", "Ahrefs", "ChatGPT", "DALL·E", "Perplexity", "Duolingo",
  "Cloudflare Worker", "Webhook", "Todoist API", "Notion API", "Next.js", "Cloudflare Pages",
  "API Integration", "Gemini API", "Code Generation", "Cloudflare D2", "Serverless Database",
  "Docusaurus", "Documentation", "SEO", "Content Monetization", "Content Creation", "Publishing",
  "Google Apps Script", "Google Forms", "Workflow Automation", "Oracle ERP", "Data Quality",
  "Data Normalization", "IBM SPSS Statistics", "Regression Analysis", "Statistical Modeling",
  "Parse Platform", "Node.js", "Express.js", "Digital Ocean Spaces", "PostgreSQL", "Scala",
  "GraphQL", "Data Analysis", "Java", "Game Development", "C (Programming Language)",
  "POS Systems", "Linear Regression", "CSV"
];

export const projects = [
  {
    title: "Todoist Notion Sync",
    description: "Utilizes Cloudflare Worker to listen to Webhook from Todoist and create a new task in Notion.",
  ...
  {
    title: "Super",
    description: "Personal portfolio website built with Next.js and Cloudflare Pages, integrating with Superbrain API. Orchestrated development using Gemini 2.5 Flash/Pro for code generation and task execution.",
    githubLink: "https://github.com/sagelga/super",
    demoLink: "https://super.sagelga.workers.dev",
  },
  {
    title: "Superbrain",
    description: "API for blog content, retrieving Notion changes and storing them in Cloudflare D2 for fast retrieval. Fully runs on Cloudflare Workers; orchestrated development using Gemini models.",
  ...
  },
  {
    ...
    description: "Rebuilt learn.sagelga.com with Docusaurus, React, and TypeScript, enhancing search and speed to empower Python and SQL learners.",
  ...
  },
  {
    ...
    description: "Developed this website to centralize all my project documentation and user manuals.",
    githubLink: "", // No GitHub link provided
    demoLink: "https://docs.sagelga.com/",
  },
  {
    title: "Byteside.one",
    description: "Founded ByteSide.one, a tech, gadget, and gaming news publication, achieving 2.79 million Google Search impressions and 200k+ monthly Facebook impressions by Jan 2023.",
    githubLink: "", // No GitHub link provided
    demoLink: "https://byteside.one/",
  },
  {
    title: "The Sunny Side Publication",
    description: "Pioneered 'The Sunny Side' publication on Medium, a precursor to ByteSide.one, showcasing early content creation and publishing expertise.",
    githubLink: "", // No GitHub link provided
    demoLink: "https://medium.com/the-sunny-side",
  },
  {
    title: "Approval Workflow on Google Apps Script",
    description: "Developed an automated approval workflow for IMST using Google Apps Script, streamlining IT, Requisition, and Procurement processes with automated email triggers and Google Forms integration.",
  ...
  },
  {
    ...
    description: "Developed Oracle SQL and PL/SQL scripts for Essilor Asia and Europe, generating supplier deduplication reports to enhance data quality in production Oracle ERP, including similarity scoring and normalization.",
    githubLink: "", // No GitHub link provided
    demoLink: "", // No demo link provided
  },
  {
    title: "Data Analytics on Body Fat",
    description: "Conducted multi-regression analysis on body fat and body part size relationships using IBM SPSS Statistics to create statistical models.",
    githubLink: "https://github.com/sagelga/bodyfat-regression",
    demoLink: "", // No demo link provided
  },
  {
    title: "Lecture sharing System (Oh Sheet!)",
    description: "Developed 'Oh Sheet!', a lecture sharing system using Vue, Parse, NodeJS, ExpressJS, and Digital Ocean Spaces, designed for easy sharing and discovery of educational content.",
  ...
  },
  {
    ...
    description: "Designed and implemented an online space reservation system with PostgreSQL, Scala, GraphQL, and NodeJS, managing user requirements and approvals for building administrators.",
  ...
  },
  {
    ...
    description: "Analyzed the prevalence of Thai restaurants in the United States, investigating underlying causes and trends.",
    githubLink: "https://github.com/sagelga/data-journal",
    demoLink: "", // No demo link provided
  },
  {
    title: "Trash Melody",
    description: "Developed 'Trash Melody', a fast-paced OSU!-inspired Java game, combining entertainment with education on trash categorization.",
  ...
  },
  {
    ...
    description: "Engineered a comprehensive Point-of-Sale (POS) system in C, featuring analytics, stock/profit management, sales forecasting (Linear Regression), customer loyalty, and barcode scanner support, with data stored in CSV format.",
...
export const certifications = [
  {
    ...
    skills: ["Snowflake", "Data Engineering", "SQL", "Data Modeling", "ETL Processes"],
  },
  {
    title: "Building Language Models on AWS",
    skills: ["Large Language Models (LLM)", "Amazon Web Services (AWS)", "Deep Learning", "AWS SageMaker", "Retrieval-Augmented Generation"],
  },
  {
    title: "Foundations of Prompt Engineering",
    skills: ["Prompt Engineering", "Amazon Web Services (AWS)", "AWS SageMaker", "Generative AI", "Large Language Models (LLM)"],
  },
  {
    title: "Introduction to Generative AI",
    skills: ["Generative AI", "Google Cloud Platform (GCP)", "Vector Databases", "Machine Learning", "AI Ethics"],
  },
  {
    title: "Lightning Experience Reports & Dashboards Specialist Superbadge",
    skills: ["Salesforce.com", "Report Building", "Dashboard Design", "Data Visualization", "Salesforce Analytics"],
  },
  {
    title: "Business Administration Specialist Superbadge",
    skills: ["Salesforce.com", "Business Administration", "Process Automation", "CRM Management", "Data Security"],
  },
  {
    title: "Flow Data Collections Specialist Superbadge",
    date: "June 2023",
    skills: ["Salesforce Flow", "Data Collection", "Automation", "Salesforce Integration", "Data Management"],
  },
  {
    title: "Flow Elements and Resources Specialist Superbadge",
    skills: ["Salesforce Flow", "Resource Management", "Process Builder", "Workflow Automation", "Salesforce Configuration"],
  },
  {
    title: "Flow Management Specialist Superbadge",
    skills: ["Salesforce Flow", "Process Automation", "CRM Optimization", "Data Handling", "Salesforce Maintenance"],
  },
  {
    title: "React - The Complete Guide 2023 (incl. React Router & Redux)",
    skills: ["React.js", "Redux.js", "JavaScript", "Web Development", "Front-End Architecture"],
  },
  {
    title: "MERN Stack Front To Back: Full Stack React, Redux & Node.js",
    skills: ["MERN Stack", "React.js", "TypeScript", "JavaScript", "Node.js", "Redux Thunk"],
  },
  {
    title: "Salesforce Marketing Cloud Administrator Certification",
    skills: ["Salesforce Marketing Cloud", "Email Marketing", "Automation Studio", "Journey Builder", "Data Management"],
  },
  {
    title: "The Complete Salesforce Certified Administrator Course",
    skills: ["Salesforce.com", "Salesforce Administration", "Data Management", "User Management", "Process Automation"],
  },
  {
    title: "Databases for Developers: Next Level",
    skills: ["OracleSQL", "SQL", "PL/SQL", "Database Optimization", "Advanced Querying"],
  },
  {
    title: "Databases for Developers: Foundations",
    skills: ["OracleSQL", "SQL", "Database Design", "Querying", "Data Management"],
  },
];
...
export const volunteering = [
  ...
  },
  {
    ...
    link: { text: "IT KMITL Python Pre-programming course on YouTube", href: "https://www.youtube.com/c/PreProgrammingITKMITL" },
  },
  {
...
export const languages = [
  { name: "English", proficiency: "Professional proficiency", iconClass: "devicon-english-plain" }, // Placeholder, Devicon doesn't have an English icon
  { name: "Thai", proficiency: "Native proficiency", iconClass: "devicon-thai-plain" }, // Placeholder, Devicon doesn't have a Thai icon
];

export const onlineProfiles = [
  { name: "LinkedIn", url: "https://www.linkedin.com/in/kunanon/", iconClass: "devicon-linkedin-plain" },
  { name: "GitHub", url: "https://github.com/sagelga", iconClass: "devicon-github-plain" },
  { name: "Salesforce Trailblazer", url: "https://www.salesforce.com/trailblazer/sagelga", iconClass: "devicon-salesforce-plain" },
];
